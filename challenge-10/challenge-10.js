...
// ?
    operationSignal='+'
    operationSignalSubtract = '-'

    let sum = calculator(operationSignal)
    let subtract = calculator(operationSignalSubtract)
    /*
    PASSO 3:
...
// ?
    ...
    number2 = 10
    if(subtract){
        console.log(showOperationMessage(operationSignalSubtract,number1,number2),subtract(number1,number2))
    }else {
        console.log(showErrorMessage(operationSignal))
    }
    /*
